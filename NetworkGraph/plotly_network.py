...
logo = Image.open(r'Aniappd\mylogo.JPG')
...
# brought the above code from sidebar.py
...
if uploaded_file is not None:     
    ...
    with col1:
        layout= st.selectbox('Choose a network layout',('Random Layout','Spring Layout','Shell Layout','Spectral Layout'))
    with col2:
    ...
    for n, p in pos.items():
        G.nodes[n]['pos'] = p
    # bring code from plotly_network.py    
